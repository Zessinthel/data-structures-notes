...
% ─── Colores para tablas (usando nombres temáticos de Catppuccin) ────────────
\colorlet{tableheadcolor}{background}      % antes CtpBlue!12
\colorlet{tableheadtext}{maintext}           % antes CtpText
\colorlet{tablerowalt}{surface0!30}          % antes CtpSurface0!30
\colorlet{tablerule}{overlay0!50}            % antes CtpOverlay0!50
